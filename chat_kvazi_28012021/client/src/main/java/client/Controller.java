...
public class Controller implements Initializable {
    private static final String LOG_FILENAME = "chat_history.txt";
    private static final int LOG_LOADSTR = 100;
    ...
    private void readHistory(){
        chatHistory = new TextFile(nickname + "_" + LOG_FILENAME);
        System.out.println("Read history log");

        Platform.runLater(() -> {
            System.out.println("Fill history");
            Iterator<String> it = chatHistory.lastIterator(LOG_LOADSTR);
            while(it.hasNext())
    ...
    private void writeHistory(){
        System.out.println("Write to history log " + nickname + "_" + LOG_FILENAME);
        TextFile.writeToFile(chatHistory, nickname + "_" + LOG_FILENAME);
    }
